...
<head>
    ...
    <title>Edit Data Pengiriman - Anda Expedition</title>
    ...
    <main class="flex-grow flex flex-col md:ml-64 w-full bg-background min-h-screen">
        ...
        <div class="p-margin-mobile md:p-margin-desktop max-w-container-max mx-auto w-full flex-grow flex flex-col">
            <div class="mb-stack-lg flex items-center gap-stack-sm">
                ...
                <h2 class="font-headline-md text-headline-md text-on-background">Edit Data Pengiriman ({{ $pengiriman->no_resi }})</h2>
            </div>
            @if ($errors->any())
                <div
                    ...
                    <div class="space-y-stack-md">
                        ...
                        <div class="flex flex-col gap-stack-xs">
                            ...
                            <input
                                ...
                                required="" type="text" value="{{ $pengiriman->nama_pengirim }}" />
                        </div>
                        <div class="flex flex-col gap-stack-xs">
                            <label
                                class="font-label-sm text-label-sm text-on-surface-variant uppercase flex items-center"
                            ...
                            <textarea
                                ...
                                rows="3">{{ $pengiriman->alamat_pengirim }}</textarea>
                        </div>
                    </div>
                    <!-- Receiver Section -->
                    <div class="space-y-stack-md">
                        ...
                        <div class="flex flex-col gap-stack-xs">
                            ...
                            <input
                                ...
                                required="" type="text" value="{{ $pengiriman->nama_penerima }}" />
                        </div>
                        <div class="flex flex-col gap-stack-xs">
                            <label
                                class="font-label-sm text-label-sm text-on-surface-variant uppercase flex items-center"
                            ...
                            <textarea
                                ...
                                rows="3">{{ $pengiriman->alamat_penerima }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-gutter gap-y-stack-md">
                            <div class="flex flex-col gap-stack-xs">
                                ...
                                <textarea
                                    ...
                                    required="" rows="4">{{ $pengiriman->detail_barang }}</textarea>
                            </div>
                                ...
                                <div class="flex flex-col gap-stack-xs">
                                    ...
                                    <div class="relative">
                                        <select
                                            ...
                                            <option value="pending" {{ $pengiriman->status == 'pending' ? 'selected' : '' }}>Pending</option>
                                            <option value="processing" {{ $pengiriman->status == 'processing' ? 'selected' : '' }}>Diproses</option>
                                            <option value="shipped" {{ $pengiriman->status == 'shipped' ? 'selected' : '' }}>Dikirim</option>
