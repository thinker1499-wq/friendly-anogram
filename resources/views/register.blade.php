...
<head>
    ...
    <title>Register - Anda Expedition</title>
...
<body
    ...
    <main class="relative z-10 w-full max-w-[420px] px-margin-mobile md:px-0">
        ...
        <div class="text-center mb-stack-lg">
            ...
            <h1 class="text-headline-md font-headline-md text-on-surface tracking-tight">Create Account</h1>
            <p class="text-body-md font-body-md text-on-surface-variant mt-stack-xs">Join Anda Expedition</p>
        </div>
        <!-- Register Card -->
        <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-stack-lg shadow-sm">
            ...
            <form action="{{ route('register') }}" class="space-y-stack-md" method="POST">
                ...
                <!-- Name Field -->
                <div>
                    <label class="block text-label-sm font-label-sm text-on-surface mb-stack-xs" for="name">Full
                        Name</label>
                    <div class="relative">
